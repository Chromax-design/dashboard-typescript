...
const layout = async ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <main className="sm:grid sm:grid-cols-12 w-full gap-0 max-sm:py-20 max-sm:min-h-screen max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
